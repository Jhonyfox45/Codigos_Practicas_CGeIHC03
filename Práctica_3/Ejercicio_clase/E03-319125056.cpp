...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//A PARTIR DE ACA HACEMOS LAS FIGURAS PARA EL HOLOCRON

		//1er cubo azul "Grande" Rotado 45 grados en Z
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.05f, -1.5f));
		model = glm::rotate(model, 45 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.12f, 0.12f, 0.12f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection)); //DEFINIR UNA SOLA VEZ 
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.0f, 0.0f, 1.0f);  //YA NO USAMOS SHADERS AHORA USAMOS ESTAS DOS LINEAS
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		//1er cubo cafe "pequeño" Rotado 45 grados en Z
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.05f, -1.46));
		model = glm::rotate(model, 45 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		//2do cubo azul "Grande" Rotado 45 grados en Z
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.025f, 0.05f, -1.525f));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		//2do cubo cafe "pequeño" Rotado 45 grados en Z
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.065f, 0.05f, -1.525));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, 45 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.06f, 0.06f, 0.06f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		//3er cubo azul "Grande" Rotado 45 grados en Z
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.025f, 0.05f, -1.525f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, 45 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		//3er cubo cafe "pequeño" Rotado 45 grados en Z
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.065f, 0.05f, -1.525));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, 45 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		//4to cubo azul "Grande" Rotado 45 grados en Z
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.05f, -1.55f));
		model = glm::rotate(model, 45 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.12f, 0.12f, 0.12f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		//4to cubo cafe "pequeño" Rotado 45 grados en Z
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.05f, -1.59));
		model = glm::rotate(model, 45 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.06f, 0.06f, 0.06f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		//5to cubo azul "Grande" Rotado 45 grados en Z
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.075f, -1.525f));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		//5to cubo cafe "pequeño" Rotado 45 grados en Z
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.115f, -1.525));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, 45 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.06f, 0.06f, 0.06f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		//6to cubo azul "Grande" Rotado 45 grados en Z
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.025f, -1.525f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, 45 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.12f, 0.12f, 0.12f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		//6to cubo cafe "pequeño" Rotado 45 grados en Z
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f,-0.015f, -1.525));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, 45 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.06f, 0.06f, 0.06f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		//Hacemos la piramide amarilla "chata" (FRENTE)
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.052f, 0.105f, -1.425f));
		model = glm::rotate(model, 45 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, 38 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f)); 	
		model = glm::scale(model, glm::vec3(0.12f, 0.04f, 0.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(1.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh();
		//Hacemos la piramide roja "chata" (FRENTE)
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.052f, 0.105f, -1.425f));
		model = glm::rotate(model, -45 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, 38 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh();
		//Hacemos la piramide Magenta "chata" (FRENTE)
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.052f, -0.005f, -1.425f));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh();
		//Hacemos la piramide Verde "chata" (FRENTE)
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.052f, -0.005f, -1.425f));
		model = glm::rotate(model, -135 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, 38 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh();
		//Hacemos la piramide Amarilla "chata" (ATRAS)
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.052f, 0.105f, -1.625f));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh();
		//Hacemos la piramide Roja "chata" (ATRAS)
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.052f, 0.105f, -1.625f));
		model = glm::rotate(model, 180 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, -45 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh();
		//Hacemos la piramide Magenta "chata" (ATRAS)
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.052f, -0.005f, -1.625f));
		model = glm::rotate(model, 180 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, 135 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, 38 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.12f, 0.04f, 0.2f));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh();
		//Hacemos la piramide Verde "chata" (ATRAS)
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.052f, -0.005f, -1.625f));
		model = glm::rotate(model, 180 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, -135 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		...
		//Piso de color negro
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -0.15f, -1.4f));
		model = glm::scale(model, glm::vec3(1.5f, 0.03f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
